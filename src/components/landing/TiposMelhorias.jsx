    ...
    <section className="page-section">
      <header className="page-section__header">
        ...
        <p className="page-section__lead">
          Cada novidade entregue no VendaAI se enquadra em uma destas categorias. A
          diferença está em <em>como</em> habilitar.
        </p>
      </header>
      ...
      <div className="landing-tipos">
        <article className="landing-tipo landing-tipo--padrao">
          ...
          <p className="landing-tipo__desc">
            Funcionalidades <strong>já prontas</strong> que qualquer cliente pode ativar
            sem custo adicional.
          </p>
          <ul className="landing-tipo__list">
            <li>
              Habilitação <strong>gratuita</strong>
            </li>
        ...
        <article className="landing-tipo landing-tipo--modulado">
          ...
          <p className="landing-tipo__desc">
            Recursos avançados que demandam <strong>desenvolvimento dedicado</strong> e
            habilitação pela equipe comercial.
          </p>
          <ul className="landing-tipo__list">
