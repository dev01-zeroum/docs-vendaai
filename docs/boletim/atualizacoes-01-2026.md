...
<BoletimHeader dataPublicacao="janeiro de 2026">
...
![Atualização automática de preços](https://i.imgur.com/qRAEyeC.jpeg)

Para acessar, é necessário habilitar as copias de venda, e ir em pedidos → configurações → copiar venda
...
**Para acessar você pode ir em Vendas → Criar novo pedido → adicionar produto → Configurador**

![Configurador de Produtos 2](https://imgur.com/TeyEXuU.png)

Durante a criação de um produto configurado, é possível selecionar e combinar diferentes componentes, como terminais, capas, acessórios e demais itens disponíveis para o produto base, modelando o produto configurado conforme sua necessidade!
...
O painel de cobrança permite visualizar e gerenciar títulos de dívida de forma centralizada, facilitando o acompanhamento de pendências financeiras.

![Painel de cobrança](https://i.imgur.com/byxg9cY.png)
