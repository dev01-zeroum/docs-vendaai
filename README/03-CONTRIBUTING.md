---
sidebar_position: 99
title: Contribuindo - Workflow em Equipe
---
...
```
Line 15: "documentação" está com acento errado

Sugiro: "documentação" → "documentação"
```
...
```bash
# GitHub Actions detecta merge em main
...
docs/
├── manual/
│   ├── dev1-secao.md      # Dev 1 edita isso
│   └── dev2-secao.md      # Dev 2 edita isso
├── faq/
│   ├── seguranca.md       # Dev 1
│   └── integracao.md      # Dev 2
└── boletim/
...
Assim não há edições simultâneas no mesmo arquivo.
...
- [ ] Build passou: `npm build` (sem erros)
